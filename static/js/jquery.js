 ...
 */
  ...
  jQuery.extend({
    ...
    cleanData: function(elems) {
      let data, elem, events, type, key, j,
 ...
 */
  ...
  function actualDisplay(name, doc) {
    let elem = jQuery(doc.createElement(name)).appendTo(doc.body),
 ...
 */
  ...
  (function() {
    let pixelPositionVal, boxSizingReliableVal,
  ...
  function defaultPrefilter(elem, props, opts) {
    ...
    let prop, value, toggle, tween, hooks, oldfire, display,
      anim = this,
      orig = {},
      style = elem.style,
  ...
  jQuery.fn.extend({
    addClass: function(value) {
      let classes, elem, cur, clazz, j, finalValue,
