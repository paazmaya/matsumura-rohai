...
<span class="function"><span class="keyword">function</span> <span class="title">etag</span><span class="params">(entity, options)</span> {</span>
  ...
  <span class="keyword">var</span> isBuffer = Buffer.isBuffer(entity)
  ...
  <span class="keyword">if</span> (!isBuffer &amp;&amp; <span class="keyword">typeof</span> entity !== <span class="string">'string'</span>) {
  ...
  <span class="keyword">var</span> buf = !isBuffer
    ? <span class="keyword">new</span> Buffer(entity, <span class="string">'utf8'</span>)
    : entity
  <span class="keyword">var</span> hash = weak &amp;&amp; buf.length &lt;= crc32threshold
    ? weakhash(buf)
    : stronghash(buf)
...
<span class="function"><span class="keyword">function</span> <span class="title">stronghash</span><span class="params">(buf)</span> {</span>
...
<span class="function"><span class="keyword">function</span> <span class="title">weakhash</span><span class="params">(buf)</span> {</span>
  <span class="keyword">if</span> (buf.length === <span class="number">0</span>) {
    <span class="comment">// fast-path empty</span>
    <span class="keyword">return</span> <span class="string">'0-0'</span>
  }

  <span class="keyword">return</span> buf.length.toString(<span class="number">16</span>) + <span class="string">'-'</span> + crc(buf).toString(<span class="number">16</span>)
}
</code></pre>